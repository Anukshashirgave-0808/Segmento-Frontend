    ...
    <div className="min-h-screen py-20">
      ...
      <section className="py-16 bg-linear-to-br from-primary/5 to-purple-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto bg-white rounded-2xl border-4 border-purple-500 shadow-xl p-8 md:p-12 hover:shadow-2xl transition-shadow">
            <div className="flex flex-col md:flex-row gap-8 items-start">
              <div className="shrink-0 flex flex-col items-center gap-4">
                <div className="relative w-48 h-48 rounded-full overflow-hidden border-4 border-purple-300">
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            {team.map((member) => (
              <div
                key={member.name}
                className="bg-white rounded-2xl border-4 border-purple-500 shadow-lg p-6 hover:shadow-2xl transition-all duration-500"
              >
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
            {missions.map((mission) => (
              <div
                key={mission.title}
                className="bg-white rounded-2xl border-4 border-purple-400 shadow-lg p-8 animate-fade-in-up"
              >
