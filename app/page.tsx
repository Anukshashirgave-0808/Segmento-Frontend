...
export const metadata = {
  ...
  description:
    "Privacy-first, AI-driven data products that solve real enterprise challenges. Transform how you protect and analyze sensitive information.",
};

export default function HomePage() {
  // -----------------------------
  // Step 2: Scroll to Products if hash is #products
  // -----------------------------
  useEffect(() => {
    if (typeof window !== "undefined" && window.location.hash === "#products") {
      const el = document.getElementById("products");
      if (el) {
        // Delay ensures the DOM has rendered
        setTimeout(() => {
      ...
      <section id="products" className="py-16 md:py-24 bg-gradient-to-br from-primary/5 to-purple-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8 border border-border/50 hover:shadow-2xl transition-shadow">
              <div className="flex flex-col h-full">
                <h3 className="text-2xl md:text-3xl font-bold mb-4">Segmento Sense</h3>
                <p className="text-lg text-muted-foreground mb-6">
