...
export default function NewsCard({ article }: NewsCardProps) {
    ...
    const articleLink = `/pulse/news/article?url=${encodeURIComponent(article.url)}&title=${encodeURIComponent(article.title)}&description=${encodeURIComponent(article.description || '')}&image=${encodeURIComponent(article.image)}&date=${encodeURIComponent(article.publishedAt)}&source=${encodeURIComponent(article.source)}`;
